  ...
  export default {
    ...
    methods: {
      search () {
        ...
        if (!this.startDate && !this.endDate) {
          ...
          if (this.method === '' && this.category !== '') {
            url = '/api/log?category=' + this.category
          } else if (this.method !== '' && this.category === '') {
            url = '/api/log?method=' + this.method
          } else if (this.method !== '' && this.category !== '') {
            url = '/api/log?method=' + this.method + '&category=' + this.category
          } else {
            url = '/api/log'
          }
          ...
          if (this.method === '' && this.category !== '') {
            url = '/api/log?category=' + this.category + '&startDate=' + startDate + '&endDate=' + endDate
          } else if (this.method !== '' && this.category === '') {
            url = '/api/log?method=' + this.method + '&startDate=' + startDate + '&endDate=' + endDate
          } else if (this.method !== '' && this.category !== '') {
            url = '/api/log?method=' + this.method + '&category=' + this.category + '&startDate=' + startDate + '&endDate=' + endDate
          } else {
            url = '/api/log?' + '&startDate=' + startDate + '&endDate=' + endDate
          }
        } else {
      ...
      filterChange (filterObj) {
        ...
        _this.$axios.get('/api/category/' + filterObj.category[_this.curNum])
          .then((response) => {
            if (_this.curNum === 0) {
              _this.logs = []
            }
